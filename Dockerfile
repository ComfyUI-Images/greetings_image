...
RUN echo "Token value: $CIVITAI_TOKEN" && mkdir -p /comfyui/models/checkpoints /comfyui/models/loras && \
    ...
    curl -L -H "Authorization: Bearer ${CIVITAI_TOKEN}" -o /comfyui/models/loras/Seductive_Finger_Lips_Expression_SDXL-000046.safetensors "https://civitai.com/api/download/models/2277333?type=Model&format=SafeTensor"
